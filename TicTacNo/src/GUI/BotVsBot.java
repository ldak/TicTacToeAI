...
public class BotVsBot extends JFrame implements Runnable{
	...
	public QBot bot1;
	public QBot bot2;
	public File saveFile=new File("./ticTacToe.save");
	...
	private void gameLogic() throws InterruptedException {
		...
		if (isWin(getBoard(),"O")) {
			bot1.setRelard(0f);
			bot1.getStrategy().lost();
			System.out.println("lost - game: "+games);
